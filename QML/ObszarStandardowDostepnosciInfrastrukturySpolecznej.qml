...
<qgis labelsEnabled="1" simplifyDrawingHints="0" simplifyMaxScale="1" symbologyReferenceScale="-1" version="3.22.15-Białowieża" minScale="100000000" simplifyAlgorithm="0" simplifyLocal="1" styleCategories="Symbology|Symbology3D|Labeling|Fields|Forms|Actions|MapTips|Diagrams|AttributeTable|Rendering|CustomProperties|GeometryOptions|Relations|Temporal|Legend|Elevation|Notes" hasScaleBasedVisibilityFlag="0" maxScale="0" simplifyDrawingTol="2">
  <temporal endExpression="" startField="" mode="0" durationField="fid" startExpression="" enabled="0" accumulate="0" limitMode="0" durationUnit="min" endField="" fixedDuration="0">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
      ...
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" name="0" type="fill">
        ...
        <layer locked="0" pass="0" enabled="1" class="SimpleLine">
          <Option type="Map">
            ...
            <Option name="line_color" type="QString" value="83,83,83,255"/>
            ...
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="outlineWidth" type="Map">
                  ...
                  <Option name="expression" type="QString" value="if (@zoom_level &lt; 15,0.2,0.4)"/>
        ...
        <layer locked="0" pass="0" enabled="1" class="LinePatternFill">
          ...
          <symbol alpha="1" clip_to_extent="1" force_rhr="0" name="@0@1" type="line">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style textColor="50,50,50,255" legendString="Aa" capitalization="0" fontWeight="50" fontSize="3" multilineHeight="1" useSubstitutions="0" fontStrikeout="0" fontSizeUnit="MM" fontItalic="0" allowHtml="0" fieldName="oznaczenie" fontWordSpacing="0" fontUnderline="0" namedStyle="Normal" isExpression="0" previewBkgrdColor="255,255,255,255" textOpacity="1" textOrientation="horizontal" fontKerning="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" blendMode="0" fontFamily="Arial" fontLetterSpacing="0">
        <families/>
        <text-buffer bufferOpacity="1" bufferSize="0.5" bufferJoinStyle="128" bufferBlendMode="0" bufferDraw="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSizeUnits="MM" bufferColor="250,250,250,255" bufferNoFill="1"/>
        <text-mask maskEnabled="0" maskType="0" maskJoinStyle="128" maskedSymbolLayers="" maskSizeUnits="MM" maskOpacity="1" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskSize="0"/>
        <background shapeOffsetY="0" shapeOffsetX="0" shapeRadiiX="0" shapeSizeType="0" shapeDraw="0" shapeBlendMode="0" shapeRadiiY="0" shapeJoinStyle="64" shapeRadiiUnit="Point" shapeOpacity="1" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeSizeUnit="Point" shapeBorderWidthUnit="Point" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidth="0" shapeSizeY="0" shapeSVGFile="" shapeSizeX="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeRotationType="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeType="0" shapeFillColor="255,255,255,255" shapeRotation="0" shapeBorderColor="128,128,128,255" shapeOffsetUnit="Point">
        ...
        <shadow shadowOffsetDist="1" shadowOffsetGlobal="1" shadowRadiusMapUnitScale="3x:0,0,0,0,0,0" shadowDraw="0" shadowOffsetAngle="135" shadowRadiusUnit="MM" shadowScale="100" shadowBlendMode="6" shadowOpacity="0.69999999999999996" shadowRadiusAlphaOnly="0" shadowRadius="1.5" shadowColor="0,0,0,255" shadowUnder="0" shadowOffsetUnit="MM" shadowOffsetMapUnitScale="3x:0,0,0,0,0,0"/>
        <dd_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
      ...
      <text-format autoWrapLength="0" formatNumbers="0" leftDirectionSymbol="&lt;" wrapChar="" addDirectionSymbol="0" decimals="3" reverseDirectionSymbol="0" multilineAlign="3" useMaxLineLengthForAutoWrap="1" rightDirectionSymbol=">" placeDirectionSymbol="0" plussign="0"/>
      <placement rotationUnit="AngleDegrees" geometryGeneratorType="PointGeometry" rotationAngle="0" repeatDistanceUnits="MM" placement="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" distUnits="MM" centroidWhole="0" overrunDistance="0" dist="0" distMapUnitScale="3x:0,0,0,0,0,0" priority="5" repeatDistance="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorClipping="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" polygonPlacementFlags="2" geometryGeneratorEnabled="0" centroidInside="1" xOffset="0" maxCurvedCharAngleIn="25" fitInPolygonOnly="0" lineAnchorPercent="0.5" geometryGenerator="" yOffset="0" maxCurvedCharAngleOut="-25" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" overrunDistanceUnit="MM" lineAnchorType="0" offsetType="0" layerType="PolygonGeometry" offsetUnits="MM" preserveRotation="1" placementFlags="10" quadOffset="4"/>
      <rendering drawLabels="1" maxNumLabels="2000" fontMinPixelSize="3" obstacle="1" mergeLines="0" scaleVisibility="0" labelPerPart="0" displayAll="0" scaleMin="0" obstacleFactor="1" fontMaxPixelSize="10000" limitNumLabels="0" minFeatureSize="0" fontLimitPixelSize="0" zIndex="0" obstacleType="1" upsidedownLabels="0" scaleMax="0" unplacedVisibility="0"/>
      <dd_properties>
        <Option type="Map">
          <Option name="name" type="QString" value=""/>
          <Option name="properties" type="Map">
            <Option name="Size" type="Map">
              <Option name="active" type="bool" value="true"/>
              <Option name="expression" type="QString" value="if (@zoom_level &lt; 15,0,3)"/>
              <Option name="type" type="int" value="3"/>
            </Option>
          </Option>
          <Option name="type" type="QString" value="collection"/>
  ...
  <customproperties>
    <Option type="Map">
      <Option name="dualview/previewExpressions" type="List">
        <Option type="QString" value="&quot;przestrzenNazw&quot;"/>
      </Option>
  ...
  <SingleCategoryDiagramRenderer diagramType="Histogram" attributeLegend="1">
    <DiagramCategory minScaleDenominator="0" backgroundColor="#ffffff" sizeScale="3x:0,0,0,0,0,0" rotationOffset="270" spacingUnit="MM" sizeType="MM" lineSizeType="MM" penWidth="0" spacingUnitScale="3x:0,0,0,0,0,0" showAxis="1" penAlpha="255" maxScaleDenominator="1e+08" penColor="#000000" width="15" backgroundAlpha="255" scaleBasedVisibility="0" direction="0" spacing="5" labelPlacementMethod="XHeight" scaleDependency="Area" enabled="0" height="15" diagramOrientation="Up" opacity="1" minimumSize="0" lineSizeScale="3x:0,0,0,0,0,0" barWidth="5">
  ...
  <DiagramLayerSettings zIndex="0" priority="0" dist="0" showAll="1" obstacle="0" linePlacementFlags="18" placement="1">
    <properties>
      <Option type="Map">
        <Option name="name" type="QString" value=""/>
        <Option name="properties"/>
      ...
      <editWidget type="DateTime">
        <config>
          <Option type="Map">
            ...
            <Option name="display_format" type="QString" value="yyyyMMddTHHmmss"/>
            <Option name="field_format" type="QString" value="yyyyMMddTHHmmss"/>
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              <Option type="Map">
                <Option name="ogólnie wiążące" type="QString" value="ogólnie wiążące"/>
              </Option>
            </Option>
          </Option>
        </config>
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              <Option type="Map">
                <Option name="nieaktualny" type="QString" value="nieaktualny"/>
              </Option>
              <Option type="Map">
                <Option name="prawnie wiążący lub realizowany" type="QString" value="prawnie wiążący lub realizowany"/>
              </Option>
              <Option type="Map">
                <Option name="w opracowaniu" type="QString" value="w opracowaniu"/>
              </Option>
              <Option type="Map">
                <Option name="w trakcie przyjmowania" type="QString" value="w trakcie przyjmowania"/>
              </Option>
              <Option type="Map">
                <Option name="wybierz" type="QString" value="{2839923C-8B7D-419E-B84B-CA2FE9B80EC7}"/>
              </Option>
            </Option>
          </Option>
        </config>
      ...
      <editWidget type="DateTime">
        <config>
          <Option type="Map">
            <Option name="allow_null" type="bool" value="true"/>
            <Option name="calendar_popup" type="bool" value="true"/>
            <Option name="display_format" type="QString" value="yyyy-MM-ddTHH:mm:ssZ"/>
            <Option name="field_format" type="QString" value="yyyy-MM-ddTHH:mm:ssZ"/>
            <Option name="field_iso_format" type="bool" value="false"/>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias index="3" field="lokalnyId" name=""/>
    <alias index="4" field="wersjaId" name=""/>
    <alias index="5" field="nazwa" name=""/>
    <alias index="6" field="oznaczenie" name=""/>
    <alias index="7" field="symbol" name=""/>
    <alias index="8" field="charakterUstalenia" name=""/>
    <alias index="9" field="obowiazujeOd" name=""/>
    <alias index="10" field="obowiazujeDo" name=""/>
    <alias index="11" field="status" name=""/>
    <alias index="12" field="poczatekWersjiObiektu" name=""/>
    <alias index="13" field="koniecWersjiObiektu" name=""/>
    <alias index="14" field="plan" name=""/>
    <alias index="15" field="wylaczenieZabudowyZagrodowej" name=""/>
    <alias index="16" field="odlegloscDoSzkolyPodstawowej" name=""/>
    <alias index="17" field="odlegloscDoObszarowZieleniPublicznej" name=""/>
    <alias index="18" field="powierzchniaLacznaObszarowZieleniPublicznej" name=""/>
    <alias index="19" field="odlegloscDoObszaruZieleniPublicznej" name=""/>
    <alias index="20" field="powierzchniaObszaruZieleniPublicznej" name=""/>
    <alias index="21" field="odlegloscDoPrzedszkola" name=""/>
    <alias index="22" field="odlegloscDoZlobka" name=""/>
    <alias index="23" field="odlegloscDoAmbulatoriumPOZ" name=""/>
    <alias index="24" field="odlegloscDoBiblioteki" name=""/>
    <alias index="25" field="odlegloscDoDomuKultury" name=""/>
    <alias index="26" field="odlegloscDoDomuPomocySpolecznej" name=""/>
    <alias index="27" field="odlegloscDoUrzadzonegoTerenuSportu" name=""/>
    <alias index="28" field="odlegloscDoPrzystanku" name=""/>
    <alias index="29" field="odlegloscDoPlacowkiPocztowej" name=""/>
    <alias index="30" field="odlegloscDoApteki" name=""/>
    <alias index="31" field="odlegloscDoPosterunkuPolicji" name=""/>
    <alias index="32" field="odlegloscDoPosterunkuJednostkiOchronyPrzeciwpozarowej" name=""/>
  </aliases>
  <defaults>
  ...
  <constraints>
    ...
    <constraint field="gml_id" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    ...
    <constraint field="symbol" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="charakterUstalenia" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="obowiazujeOd" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="obowiazujeDo" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    ...
    <constraint field="koniecWersjiObiektu" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="plan" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="wylaczenieZabudowyZagrodowej" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="odlegloscDoSzkolyPodstawowej" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="odlegloscDoObszarowZieleniPublicznej" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="powierzchniaLacznaObszarowZieleniPublicznej" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="odlegloscDoObszaruZieleniPublicznej" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="powierzchniaObszaruZieleniPublicznej" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="odlegloscDoPrzedszkola" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="odlegloscDoZlobka" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="odlegloscDoAmbulatoriumPOZ" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="odlegloscDoBiblioteki" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="odlegloscDoDomuKultury" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="odlegloscDoDomuPomocySpolecznej" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="odlegloscDoUrzadzonegoTerenuSportu" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="odlegloscDoPrzystanku" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="odlegloscDoPlacowkiPocztowej" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="odlegloscDoApteki" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="odlegloscDoPosterunkuPolicji" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint field="odlegloscDoPosterunkuJednostkiOchronyPrzeciwpozarowej" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
  </constraints>
